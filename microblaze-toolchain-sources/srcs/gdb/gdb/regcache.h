...
extern CORE_ADDR read_register (int regnum);

/* Rename to read_unsigned_register_pid()? */
extern CORE_ADDR read_register_pid (int regnum, ptid_t ptid);

extern CORE_ADDR read_signed_register (int regnum);

extern CORE_ADDR read_signed_register_pid (int regnum, ptid_t ptid);

extern void write_register (int regnum, CORE_ADDR val);
