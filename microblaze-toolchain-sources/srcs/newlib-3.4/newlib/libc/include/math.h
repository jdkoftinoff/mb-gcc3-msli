...
#include "_ansi.h"
  ...
  /* [07/19/02] Added to remove the dependency on libm.a */

#ifdef MICROBLAZE
#define HUGE_VAL 0x7ff00000
#endif

   /* [07/24/02] Even though HUGE_VAL is defined, the union _dmath is
      required by s_infconst.c of libm.a . Hence the definition of the union
      and __infinity is being pulled out of the macro */
