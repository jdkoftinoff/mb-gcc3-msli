...
(define_insn "extendsfdf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_DF"                                   ;; Xilinx
  "*
{
...
(define_insn "truncdfsf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_ALL"                                  ;; Xilinx
  "frsp %0,%1"
  [(set_attr "type" "fp")])
...
(define_insn "aux_truncdfsf2"
  ...
  "! TARGET_POWERPC && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_FULL"             ;; Xilinx
  "frsp %0,%1"
  [(set_attr "type" "fp")])
...
(define_insn ""
  ...
  "fadds %0,%1,%2"
  [(set_attr "type" "fp")
   (set_attr "fp_type" "fp_addsub_s")])                                 ;; Xilinx
...
(define_insn ""
  ...
  "fmuls %0,%1,%2"
  [(set_attr "type" "fp")
   (set_attr "fp_type" "fp_mul_s")])                                    ;; Xilinx
...
(define_expand "divsf3"
  [(set (match_operand:SF 0 "gpc_reg_operand" "")
	(div:SF (match_operand:SF 1 "gpc_reg_operand" "")
		(match_operand:SF 2 "gpc_reg_operand" "")))]
  "TARGET_HARD_FLOAT && TARGET_FPU_FULL"                                                ;; Xilinx
  "")
...
(define_insn ""
  ...
  "fmadds %0,%1,%2,%3"
  [(set_attr "type" "fp")
   (set_attr "fp_type" "fp_maddsub_s")])                                ;; Xilinx
...
(define_expand "sqrtsf2"
  ...
  "(TARGET_PPC_GPOPT || TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_FULL"    ;; Xilinx
  "")

(define_insn ""
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
	(sqrt:SF (match_operand:SF 1 "gpc_reg_operand" "f")))]
  "(TARGET_PPC_GPOPT || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_FULL"                     ;; Xilinx
  "fsqrts %0,%1"
  [(set_attr "type" "ssqrt")])
...
(define_insn ""
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
	(sqrt:SF (match_operand:SF 1 "gpc_reg_operand" "f")))]
  "TARGET_POWER2 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_FULL"                ;; Xilinx
  "fsqrt %0,%1"
  [(set_attr "type" "dsqrt")])
...
(define_insn "adddf3"
  ...
  "{fa|fadd} %0,%1,%2"
  [(set_attr "type" "fp")
   (set_attr "fp_type" "fp_addsub_d")])                                                 ;; Xilinx
...
(define_insn "muldf3"
  ...
  "{fm|fmul} %0,%1,%2"
  [(set_attr "type" "dmul")
   (set_attr "fp_type" "fp_mul_d")])                                                    ;; Xilinx

(define_insn "divdf3"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=f")
	(div:DF (match_operand:DF 1 "gpc_reg_operand" "f")
		(match_operand:DF 2 "gpc_reg_operand" "f")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_FULL && TARGET_FPU_DF"                ;; Xilinx
  "{fd|fdiv} %0,%1,%2"
  [(set_attr "type" "ddiv")])
...
(define_insn ""
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FUSED_MADD && TARGET_FPU_DF"              ;; Xilinx
  "{fma|fmadd} %0,%1,%2,%3"
  [(set_attr "type" "dmul")
   (set_attr "fp_type" "fp_maddsub_d")])                                                ;; Xilinx
...
(define_insn ""
  [(set (match_operand:DF 0 "gpc_reg_operand" "=f")
	(neg:DF (plus:DF (mult:DF (match_operand:DF 1 "gpc_reg_operand" "%f")
				  (match_operand:DF 2 "gpc_reg_operand" "f"))
			 (match_operand:DF 3 "gpc_reg_operand" "f"))))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FUSED_MADD && TARGET_FPU_DF          
   && HONOR_SIGNED_ZEROS (DFmode)"                                                      ;; Xilinx
  "{fnma|fnmadd} %0,%1,%2,%3"
  [(set_attr "type" "dmul")
   (set_attr "fp_type" "fp_maddsub_d")])                                                ;; Xilinx
...
(define_insn "sqrtdf2"
  ...
  "(TARGET_PPC_GPOPT || TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS 
    && TARGET_FPU_DF && TARGET_FPU_FULL"                                                ;; Xilinx
  "fsqrt %0,%1"
  [(set_attr "type" "dsqrt")])
...
(define_expand "maxdf3"
  [(set (match_operand:DF 0 "gpc_reg_operand" "")
	(if_then_else:DF (ge (match_operand:DF 1 "gpc_reg_operand" "")
			 ...
			 (match_dup 1)
			 (match_dup 2)))]
  "TARGET_PPC_GFXOPT && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_DF"              ;; Xilinx
  "{ rs6000_emit_minmax (operands[0], SMAX, operands[1], operands[2]); DONE;}")
...
(define_insn "*floatsidf2_internal"
  ...
  "! TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_ALL"            ;; Xilinx
  "#"
  [(set_attr "length" "24")])
...
(define_expand "fix_truncdfsi2"
  [(parallel [(set (match_operand:SI 0 "gpc_reg_operand" "")
	      ...
	      (clobber (match_dup 2))
	      (clobber (match_dup 3))])]
  "(TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_ALL"         ;; Xilinx
  "
{
...
(define_expand "floatdisf2"
  ...
  "TARGET_64BIT && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_ALL"                  ;; Xilinx
  "
{
...
(define_insn "movdf_low"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=f,!r")
        (mem:DF (lo_sum:SI (match_operand:SI 1 "gpc_reg_operand" "b,b")
                           (match_operand 2 "" ""))))]
  "TARGET_MACHO && TARGET_HARD_FLOAT && TARGET_FPRS && ! TARGET_64BIT && TARGET_FPU_DF" ;; Xilinx
  "*
{
...
(define_insn "*movdf_hardfloat32"
  ...
  "! TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FPU_DF
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"                                       ;; Xilinx    
  "*
{
  switch (which_alternative)
    {
...
(define_insn "*movdf_softfloat32"
  ...
  "! TARGET_POWERPC64 && (TARGET_SOFT_FLOAT || !TARGET_FPRS || !TARGET_FPU_DF)
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"                                       ;; Xilinx
  "*
{
...
(define_insn "*cmpsf_internal1"
  [(set (match_operand:CCFP 0 "cc_reg_operand" "=e")                                    ;; Xilinx: Use only CR1; for bug in PPC405 silicon
