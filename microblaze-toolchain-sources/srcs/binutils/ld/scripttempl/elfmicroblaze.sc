...
SECTIONS
{
  .vectors.reset 0x0 : { *(.vectors.reset) }
  .vectors.sw_exception 0x8 : { *(.vectors.sw_exception) }
  .vectors.interrupt 0x10 : { *(.vectors.interrupt) }
  .vectors.debug_sw_break 0x18 : { *(.vectors.debug_sw_break) }
  .vectors.hw_exception 0x20 : { *(.vectors.hw_exception) }
